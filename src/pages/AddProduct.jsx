      ...
      <form onSubmit={submitHandler}>
        <div className="grid grid-cols-2 gap-4 max-w-xl m-auto">
          ...
          <div className="col-span-2 text-right">
            <button onClick={submitHandler} className="rounded-lg py-3 px-6 bg-green-500 text-white font-bold w-full sm:w-32 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500">
              Add Product
            </button>
          </div>
